...
import com.promobile.cipur.databinding.ActivityNocBinding

class NocActivity : AppCompatActivity() {

    private lateinit var binding: ActivityNocBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityNocBinding.inflate(layoutInflater)
